...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Momenty Node',
    description: 'Replay this Agent conversation on Momenty Node',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Momenty Node';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Momenty Node';
